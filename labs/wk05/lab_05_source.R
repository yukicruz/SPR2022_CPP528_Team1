  ...
  list(
    "pov_rate_2000" = list(
      "nmtc" = ggplot2::ggplot( d, ggplot2::aes(x=pov.rate.00, fill=NMTC )) +
        ...
        ggplot2::ggtitle("2000 Poverty Rate")+
        ggplot2::labs(subtitle = "Recipient and Non-Recipient Communities"),
    ...
    "mhv_2000" = list(
      "nmtc" = ggplot2::ggplot( d, ggplot2::aes(x=log10(mhv.00), fill=NMTC )) +
        ggplot2::geom_density( alpha=0.4 ) +
        ggplot2::ggtitle("2000 Median Home Value of Recipient") +
        ggplot2::labs(subtitle = "Recipient and Non-Recipient Communities"),
      "lihtc" = ggplot2::ggplot( d, ggplot2::aes(x=log10(mhv.00), fill=LIHTC )) +
        ggplot2::geom_density( alpha=0.4 )  +
        ggplot2::ggtitle("2000 Median Home Value") +
        ggplot2::labs(subtitle = "Recipient and Non-Recipient Communities")),
    
    "mhv_growth" = list(
      "nmtc" = ggplot2::ggplot( d, ggplot2::aes(x=growth, fill=NMTC )) +
        ggplot2::geom_density( alpha=0.4 )  +
        ggplot2::ggtitle("MHV Growth 2000 to 2010") +
        ggplot2::labs(subtitle = "Recipients vs Non-Recipients"),
      "lihtc" = ggplot2::ggplot( d, ggplot2::aes(x=growth, fill=LIHTC )) +
        ggplot2::geom_density( alpha=0.4 )  +
        ggplot2::ggtitle("MHV Growth 2000 to 2010") + 
        ggplot2::labs(subtitle = "Recipient vs Non-Recipients")))
