...
```{r programs to load, results='asis', echo=FALSE}
...
```{r Part 1 to find Variables, results='asis', echo=FALSE}
#Just home value
df %>% head
#All variables
d %>% head()
...
```{r Part 1, results='asis', echo=FALSE}
...
```{r Median Home Value, results='asis', echo=FALSE}
...
```{r Percent Change in MHV 2000 to 2010, results='asis', echo=FALSE}
hg <-
